...
def query_regional_production_live(reference_datetime: arrow.Arrow):
    """Query regional data on production on the past day. This will create duplicates."""
    params = {"dataset": LIVE_DATASET, "q": get_datetime_query_param(reference_datetime, interval_days=1)}
